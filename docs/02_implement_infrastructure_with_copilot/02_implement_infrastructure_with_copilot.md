...
TODO
* Have GitHub Enterprise setup for your organization, and in a later exercise we will configure security best practices with GitHub advanced security
* Have a fork of the lab repository, and a local clone that you can build and run to validate the starting point of the solution
* Have installed necessary extensions to Visual Studio to support later exercises with agentic DevOps
