...
### 02: Create Infrastructure scripts in VS Code using GitHub Copilot
...
3. Launch Copilot Chat and confirm workspace context
    ...
    ![alt text](../../media/solution/0202_image-2.png)
...
### 03: Execute the Infrastructure scripts
...
azd init
```
![azd init command requirements](../../media/solution/02_02_azd_init_1.png)

Select the default option to scan the current directory

![azd init command requirements](../../media/solution/02_02_azd_init_2.png)
...
![azd init command requirements](../../media/solution/02_02_azd_init_3.png)
...
![azd provision location](../../media/solution/02_02_azd_provision_6.png)
